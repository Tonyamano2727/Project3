    ...
    <div className="flex flex-col w-full items-center">
      <div className="flex w-[95%] justify-start items-start">
        <button
          ...
          className="p-2 bg-gradient-to-r from-[#979db6] to-gray-300 rounded-2xl w-[15%] text-[14px] text-center">
          + New Hotdistric
        </button>
      </div>
      ...
      {showCreateForm && (
        <div className="w-[95%] mt-5">
          ...
          <button
            ...
            className="bg-gradient-to-r from-[#979db6] to-gray-300 px-4 py-2 rounded-full mr-2">
            Create
          </button>
          <button
      ...
      <div className="border rounded-2xl p-5 mt-5 bg-white z-1 w-[95%] flex flex-col items-center">
