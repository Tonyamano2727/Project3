...
export {default as Stepwork} from './Stepwork/Stepwork'
export {default as Workgalary} from './Workgalary/Workgalary'
export {default as Frombooking} from './Frombooking/Frombooking'
export {default as Chart} from './Chart/Chartjs'
export {default as Dayreward} from './Dayreward/Dayreward'
export {default as Monthreward} from './Monthreward/Monthreward'
export {default as Infomanage} from './Infomanage/Infomanage'
